                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="prefectures_id" id="prefectures_id" required
                                                    ...
                                                    <option value="1"
                                                        {{ old('prefectures_id') == 1 ? 'selected' : '' }}>北海道</option>
                                                    <option value="2"
                                                        {{ old('prefectures_id') == 2 ? 'selected' : '' }}>青森県</option>
                                                    <option value="3"
                                                        {{ old('prefectures_id') == 3 ? 'selected' : '' }}>岩手県</option>
                                                    <option value="4"
                                                        {{ old('prefectures_id') == 4 ? 'selected' : '' }}>宮城県</option>
                                                    <option value="5"
                                                        {{ old('prefectures_id') == 5 ? 'selected' : '' }}>秋田県</option>
                                                    <option value="6"
                                                        {{ old('prefectures_id') == 6 ? 'selected' : '' }}>山形県</option>
                                                    <option value="7"
                                                        {{ old('prefectures_id') == 7 ? 'selected' : '' }}>福島県</option>
                                                    <option value="8"
                                                        {{ old('prefectures_id') == 8 ? 'selected' : '' }}>茨城県</option>
                                                    <option value="9"
                                                        {{ old('prefectures_id') == 9 ? 'selected' : '' }}>栃木県</option>
                                                    <option value="10"
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div class="flex flex-col">
                                                    <div class="flex">
                                                        <div class="flex mr-6">
                                                            <input id="monthly_salary" type="radio" name="wage_type"
                                                                value="0" required
                                            ...
                                            <div class="relative">
                                                ...
                                                <select name="age" id="age" required
                                                    ...
                                                    <option value="4" {{ old('age') == 4 ? 'selected' : '' }}>
                                                        40歳~</option>
                                                    <option value="5" {{ old('age') == 4 ? 'selected' : '' }}>
                                                        年齢制限なし</option>
                                                </select>
                                            </div>
                                        </div>
